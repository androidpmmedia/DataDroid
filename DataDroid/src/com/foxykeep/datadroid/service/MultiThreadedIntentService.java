 ...
 * thread. The MultiThreadedIntentService class exists to simplify this pattern and take care of
 * the
 ...
 * <p>
 * For obvious efficiency reasons, MultiThreadedIntentService won't stop itself as soon as all
 * tasks
 * has been processed. It will only stop itself after a certain delay (about 30s). This
 * optimization
