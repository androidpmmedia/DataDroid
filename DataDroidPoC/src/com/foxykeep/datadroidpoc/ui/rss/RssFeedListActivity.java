...
public final class RssFeedListActivity extends DataDroidActivity
    implements RequestListener, OnClickListener, OnItemClickListener,
  ...
  protected void onRestoreInstanceState(Bundle savedInstanceState) {
    ...
    ArrayList<RssItem> rssItemList =
        savedInstanceState.getParcelableArrayList(SAVED_STATE_RSS_ITEM_LIST);
  ...
  public void onRequestFinished(Request request, Bundle resultData) {
    if (mRequestList.contains(request)) {
      ...
      RssFeed rssFeed = resultData.getParcelable(PoCRequestFactory.BUNDLE_EXTRA_RSS_FEED_DATA);
