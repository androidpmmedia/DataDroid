...
public class CustomRequestExceptionActivity extends DataDroidActivity
  ...
  protected void onRestoreInstanceState(Bundle savedInstanceState) {
    ...
    ArrayList<City> cityItemList = savedInstanceState.getParcelableArrayList(SAVED_STATE_CITY_LIST);
