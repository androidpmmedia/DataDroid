...
public final class AuthenticationActivity extends DataDroidActivity
  ...
  public void onRequestFinished(Request request, Bundle resultData) {
    if (mRequestList.contains(request)) {
      ...
      mTVResult.setText(resultData.getString(PoCRequestFactory.BUNDLE_EXTRA_AUTHENTICATION_RESULT));
    }
  }
