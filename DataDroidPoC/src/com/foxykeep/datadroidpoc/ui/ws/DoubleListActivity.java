...
public final class DoubleListActivity extends DataDroidActivity
    implements RequestListener, OnClickListener, ConnectionErrorDialogListener {
  ...
  protected void onRestoreInstanceState(Bundle savedInstanceState) {
    ...
    ArrayList<City> cityItemListTop =
        savedInstanceState.getParcelableArrayList(SAVED_STATE_CITY_LIST_TOP);
    ArrayList<City> cityItemListBottom =
        savedInstanceState.getParcelableArrayList(SAVED_STATE_CITY_LIST_BOTTOM);
  ...
  public void onRequestFinished(Request request, Bundle resultData) {
    if (mRequestList.contains(request)) {
      ...
      ArrayList<City> cityList =
          resultData.getParcelableArrayList(PoCRequestFactory.BUNDLE_EXTRA_CITY_LIST);
