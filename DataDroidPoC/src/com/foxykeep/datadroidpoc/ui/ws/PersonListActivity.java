...
public final class PersonListActivity extends DataDroidActivity
  ...
  private void callPersonListWS() {
    setProgressBarIndeterminateVisibility(true);
    Request request =
        PoCRequestFactory.getPersonListRequest(mSpinnerReturnFormat.getSelectedItemPosition());
  ...
  class ViewHolder {
    ...
    public void populateView(Cursor c) {
      c.copyStringToBuffer(DbPerson.Columns.FIRST_NAME.getIndex(), mCharArrayBufferFirstName);
      ...
      mTextViewPostalCode.setText(
          String.valueOf(c.getInt(DbPerson.Columns.POSTAL_CODE.getIndex())));
