...
public final class CrudSyncPhoneViewActivity extends DataDroidActivity
    implements RequestListener, ConnectionErrorDialogListener {
  ...
  private void populateViews() {
    ...
    ((TextView) findViewById(R.id.tv_screen_size)).setText(
        getString(R.string.crud_phone_view_tv_screen_size_format, mPhone.screenSize));
    ((TextView) findViewById(R.id.tv_price)).setText(
        getString(R.string.crud_phone_view_tv_price_format, mPhone.price));
  }
  ...
  private void callSyncPhoneDeleteWS() {
    new ProgressDialogFragmentBuilder(this).setMessage(R.string.progress_dialog_message)
        ...
        .show();
    Request request =
        PoCRequestFactory.deleteSyncPhonesRequest(mUserId, String.valueOf(mPhone.serverId));
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (itemId) {
      ...
      case R.id.menu_delete: {
        ...
        b.setMessage(
            getString(R.string.crud_phone_view_dialog_delete_confirm_message, mPhone.name));
