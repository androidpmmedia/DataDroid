...
public final class CrudSyncPhoneListActivity extends DataDroidActivity
    implements RequestListener, OnItemClickListener, ConnectionErrorDialogListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
      ...
      ArrayList<Phone> phoneArrayList =
          savedInstanceState.getParcelableArrayList(SAVED_STATE_PHONE_ARRAY_LIST);
    ...
    switch (requestCode) {
      case ACTIVITY_FOR_RESULT_VIEW: {
        if (resultCode == RESULT_OK) {
          long deletedPhoneId = data.getLongExtra(RESULT_EXTRA_DELETED_PHONE_ID, -1);
  ...
  private void callSyncPhoneDeleteMonoWS() {
    callSyncPhoneDeleteWS(String.valueOf(mListAdapter.getItem(mPositionToDelete).serverId));
  }
  ...
  public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    if (parent == mListView) {
      ...
      intent.putExtra(CrudSyncPhoneViewActivity.INTENT_EXTRA_PHONE, mListAdapter.getItem(position));
  ...
  public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
    ...
    menu.setHeaderTitle(mListAdapter.getItem(((AdapterContextMenuInfo) menuInfo).position).name);
  }
    ...
    if (mRequestList.contains(request)) {
      ...
      switch (requestType) {
        case PoCRequestFactory.REQUEST_TYPE_CRUD_SYNC_PHONE_LIST: {
          ...
          ArrayList<Phone> syncPhoneList =
              resultData.getParcelableArrayList(PoCRequestFactory.BUNDLE_EXTRA_PHONE_LIST);
