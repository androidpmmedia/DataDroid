...
public final class PoCRequestFactory {
  ...
  // Response data
  public static final String BUNDLE_EXTRA_CITY_LIST = "com.foxykeep.datadroidpoc.extra.cityList";
  public static final String BUNDLE_EXTRA_PHONE_LIST = "com.foxykeep.datadroidpoc.extra.phoneList";
  ...
  public static final String BUNDLE_EXTRA_RSS_FEED_DATA = "com.foxykeep.datadroidpoc.extra.rssFeed";
  public static final String BUNDLE_EXTRA_RESULT = "com.foxykeep.datadroidpoc.extra.result";
   ...
   * @return The request.
   */
  public static Request addSyncPhoneRequest(String userId, String name, String manufacturer,
      String androidVersion, double screenSize, int price) {
    Request request = new Request(REQUEST_TYPE_CRUD_SYNC_PHONE_ADD);
    return addEditSyncPhoneRequest(request, userId, -1, name, manufacturer, androidVersion,
        screenSize, price);
  }
  ...
  public static Request editSyncPhoneRequest(String userId, long phoneId, String name,
    ...
    return addEditSyncPhoneRequest(request, userId, phoneId, name, manufacturer, androidVersion,
        screenSize, price);
  }

  private static Request addEditSyncPhoneRequest(Request request, String userId, long phoneId,
      String name, String manufacturer, String androidVersion, double screenSize, int price) {
    request.setMemoryCacheEnabled(true);
